...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="public/styles/slideshow.css"/>
...
<body>
  ...
  <?php include('includes/cover.php'); ?>
    <div class="main_content">
      <main>
      <h3>Welcome to Ithaca</h3>
          <p>
      ...
      <aside>
        ...
        <h3>Location</h3>
        <p> We are located down town in the Ithaca Commons </p>
      </aside>

    </div>
</div>
    <script type="text/javascript" src="public/scripts/jquery-3.6.0.js"></script>
    <script type="text/javascript" src="public/scripts/slides.js"></script>
</body>
